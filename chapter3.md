...
Ex().check_function("metrics.accuracy_score").multi(check_args(0).has_equal_value(),check_args(1).has_equal_value())
Ex().check_function("metrics.confusion_matrix").multi(check_args(0).has_equal_value(),check_args(1).has_equal_value())
